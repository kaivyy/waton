...
### Package Footprint (`pip install waton==0.1.6`)
...
- Or pin reproducible release: `pip install waton==0.1.6`
...
This release targets docs for Waton `v0.1.6`.
