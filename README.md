...
```bash
pip install waton==0.1.5
```

> Prebuilt wheels include the Rust crypto extension, with no Rust toolchain needed for installation.
...
### Package Footprint (`pip install waton==0.1.5`)
...
- Or pin reproducible release: `pip install waton==0.1.5`
...
This release targets docs for Waton `v0.1.5`.
