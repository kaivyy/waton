...
from pywa.core.errors import ConnectionError, DisconnectReason
from pywa.core.events import ConnectionEvent
from pywa.core.jid import S_WHATSAPP_NET, jid_decode
from pywa.defaults.config import (
...
from pywa.protocol.binary_codec import encode_binary_node
...
from pywa.utils.auth import AuthCreds, StoragePort, init_auth_creds
from pywa.utils.crypto import generate_keypair, hmac_sha256, sign, verify
...
class WAClient:
    ...
    async def _refresh_unregistered_creds(self) -> None:
        ...
        Older pywa builds generated signatures with a non-Baileys-compatible
